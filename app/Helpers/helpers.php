...
/* ************ You can find a default params in 'config/custom.php' file ***  */
    ...
    public static function applClasses()
    {
       ...
       */
        ...
        $allOptions = [
            ...
            'defaultLanguage' => array('en' => 'en', 'fr' => 'fr', 'ar' => 'ar'),
        ...
        //layout classes
        $layoutClasses = [
            'theme' => $data['theme'], //'semi-dark',
            'layoutTheme' => $allOptions['theme'][$data['theme']],
            'sidebarCollapsed' => $data['sidebarCollapsed'],
            'showMenu' => $data['showMenu'],
            'layoutWidth' => $data['layoutWidth'], //'full'
        ...
        if (!session()->has('locale')) {
            //dd($layoutClasses['defaultLanguage']);
