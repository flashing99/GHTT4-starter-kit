...
<head>
    ...
    <meta name="description" content="GHTT, Groupe Hôtellerie, Tourisme et Thermalisme, Hotel Algérie">
    <meta name="keywords" content="GHTT admin, dashboard , GHTT web app">
    <meta name="author" content="FLASHING99">
    <title>@yield('title') - >GHTT -Groupe Hôtellerie, Tourisme et Thermalisme</title>
