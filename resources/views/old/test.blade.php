            ...
            <div class="col-md-6 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-1">
                            <label class="form-label" for="selectDefault">Default 001</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="basic-modal">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade text-start" id="select2InModal" tabindex="-1"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-1">
                                    <select class="select2-size-lg form-select" multiple="multiple"
                            ...
                            <div class="col-12">
                                ...
                                <div class="mb-1">
                                    <select class="select2-size-sm form-select" multiple="multiple"
