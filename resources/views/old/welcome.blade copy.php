...
<div class="misc-wrapper">
    <a class="brand-logo" href="#">
        ...
        <div class="d-flex flex-column">
            ...
            <h2 class="brand-text text-primary ms-1">Groupe HTT </h2>
            <h5>Groupe Hôtellerie, Tourisme et Thermalisme</h5>
        </div>
    </a>
    <div class="misc-inner p-2 p-sm-3">
        <div class="w-100 text-center">
            <h2 class="mb-1">Bienvenu sur GHTT ADMIN</h2>
            {{-- <p class="mb-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Error explicabo
                    molestias
                    non nihil inventore, eligendi voluptas provident odit vitae ipsa quas qui aut.!
                </p> --}}

            <div class="d-flex flex-column justify-content-center bd-highlight px-5   mx-5">
