            ...
            <ul class="nav navbar-nav">
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        ...
                        <h2 class="brand-text mb-0">GHTT</h2>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <ul class="nav navbar-nav align-items-center ms-auto">
        <li class="nav-item dropdown dropdown-language">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-flag">
                ...
                <a class="dropdown-item" href="{{ url('lang/ar') }}" data-language="ar">
                    <i class="flag-icon flag-icon-dz"></i> Arabe
                </a>
        ...
        <li class="nav-item dropdown dropdown-user">
            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);"
                ...
                <span class="avatar">
                    <img class="round"
                        src="{{ Auth::user() ? Auth::user()->profile_photo_url : asset('images/portrait/small/01.jpg') }}"
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                ...
                {{-- TO REPLACE With next script (Auth::check()) 
                ...
                @else
                    <a class="dropdown-item"
                        ...
                        <i class="me-50" data-feather="log-in"></i> Connexion
                    </a>
                    <a class="dropdown-item"
                        href="{{ Route::has('register') ? route('register') : 'javascript:void(0)' }}">
                        <i class="me-50" data-feather="edit"></i> Inscription
                    </a>
